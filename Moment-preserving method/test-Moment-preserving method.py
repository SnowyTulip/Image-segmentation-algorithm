import Moment_preserving_method
...
if __name__ == "__main__":
    path_input  = "Moment-preserving method/input"
    path_output = "Moment-preserving method/output"
    ...
    for folder_name in input_folders:
        ...
        for file_name in os.listdir(path_input + "/" + folder_name):
            ...
            k , binary = Moment_preserving_method.Tsai1985(img_gray)
